...
# ======================================================
# 1) Information parameter (I) via KL + Shannon (multiplicative)
# ======================================================
def sample_information_param(dim=8):
    ...
    I_shannon = H / np.log(len(p1))  # 0 ≤ H ≤ log(dim)

    # Multiplicative combination
    I = (I_kl * I_shannon) / (1.0 + I_kl * I_shannon)

    return I   # final info parameter
