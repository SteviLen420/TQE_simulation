...
class PhysicsEngine:
    ...
    def compute_all_I_definitions(self, E: float, a: float = 1.0) -> dict:
        ...
        NEW: jensen_shannon added (symmetric KL-divergence, validated with Planck 2018 data).
        """
        ...
        return {
            ...
            'jensen_shannon': I_js  # NEW: Symmetric, bounded information measure (validated with real CMB data)
        }
