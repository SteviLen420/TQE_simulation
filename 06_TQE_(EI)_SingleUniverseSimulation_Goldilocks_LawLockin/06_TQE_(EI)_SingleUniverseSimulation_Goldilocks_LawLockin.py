...
# ===========================================================================
# Author: Stefan Len
# Description: Full Monte Carlo pipeline starting from Single-universe code
...
# ======================================================
# 6) Stability summary (counts + percentages) + bar chart
# ======================================================
stable_count   = stable_total
unstable_count = int(NUM_UNIVERSES - stable_total)
