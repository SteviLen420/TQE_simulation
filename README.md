...
➡️ [(https://img.shields.io/badge/Read_The-Story-blue)](./STORY.md) : Start here for the scientific motivation, the core concepts, and the narrative behind the TQE framework. This explains the "WHY" of the project.
