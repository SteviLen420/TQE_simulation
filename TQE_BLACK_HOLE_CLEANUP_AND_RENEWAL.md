...
The generalized second law keeps the total entropy budget monotonic: $S_{\text{tot}}(t) = \sum_i S_{\text{BH},i}(t) + S_{\text{rad}}(t) + S_{\text{dS}}, \quad dS_{\text{tot}}/dt \ge 0.$
...
With black holes gone, the strongest information store is the cosmological horizon. The Bousso/’t Hooft bound constrains $S \le k_B A / (4 L_P^2), \quad A = 4\pi (c / H_\Lambda)^2,$
