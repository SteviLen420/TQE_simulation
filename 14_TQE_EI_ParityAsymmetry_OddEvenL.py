...
# (E, I) Parity Asymmetry – odd vs. even ℓ multipoles
# ================================================================

# Author: Stefan Lengyel
# Description: Simulation of parity asymmetries in the CMB power spectrum, 
# based on TQE multiverse model with energy (E) and information (I) coupling.
# Focus: Analysis of the power discrepancy between odd and even multipole moments (ℓ),
# across simulated universes.
# Goal: Evaluate whether asymmetries emerge statistically from 
# Goldilocks conditions and informational orientation.
