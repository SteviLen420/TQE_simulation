...
# (E, I) Hemisphere Asymmetry simulation
# ================================================================

# Author: Stefan Lengyel
# Description: Simulation of hemispherical asymmetry anomalies in 
# the cosmic microwave background (CMB), within a multiverse model
# based on energy (E) and information (I) coupling.
# Focus: Detection of large-scale directional imbalance in entropy,
# orientation, and law-lock-in strength across universes.
# Includes KL divergence-based informational asymmetry metric.
