...
# energy (E) and information (I). Here I is the normalized Shannon entropy
# of a random quantum state (0..1). We analyze stabilization (“lock-in”)
# on X = E·I, detect a Goldilocks window on P(stable | X), add XAI (SHAP+LIME),
...
# ======================================================
params = {
    "N_samples": 1000,    # Monte Carlo universes (set higher if you like)
    "N_epoch": 30,        # time steps (30 works well for Goldilocks detection)
...
def sigma_goldilocks(X, sigma0, alpha, E_c_low, E_c_high):
    ...
    dist = abs(X - mid) / max(width, 1e-12)  # 0 center, 1 edges
...
# ======================================================
# 12) Save all outputs to Google Drive (SHANNON base)
# ======================================================
